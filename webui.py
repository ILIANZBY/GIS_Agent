...
if __name__ == "__main__":
    ...
    with st.sidebar:
        st.image(
            get_img_base64("/share/home/wuqingyao_zhangboyang/GIS_Agent2/img/image.png"), use_column_width=True
        )
        st.caption(
            # f"""<p align="right">当前版本：{__version__}</p>""",
            f"""<p align="right">当前版本：0.0.1</p>""",
            unsafe_allow_html=True,
        )
        ...
        selected_page = sac.menu(
            [
                ...
                sac.MenuItem("GIS 审核助手", icon="globe2"),  
            ],
            key="selected_page",
            open_index=0,
        )
    ...
    elif selected_page == "GIS 审核助手":
        # 这里只是简单打开链接
        js = f"window.open('http://localhost:7860')"
